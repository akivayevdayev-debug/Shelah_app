...
# Phase 1 backend refactor (plan.md): typography/formatting layer moved to
# backend/utils/text_engine.py. Re-imported here as back-compat shims so any
# code still importing these names from `app` keeps working unchanged.
